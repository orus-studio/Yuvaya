...
const Chatbot: React.FC = () => {
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      const latency =
        typeof data === "object" && data.latency !== undefined ? Number(data.latency) : undefined;
      ...
      setMessages((m) => [
        ...m,
        { id: botId, sender: "bot", text: "Unable to connect. Please try again." },
      ]);
    } finally {
      setSending(false);
      setTyping(false);
          ...
          <div className="relative overflow-hidden px-5 py-4 bg-[#26312d]">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="font-poppins text-[15px] font-medium text-[#fffdf2]">
                    Yuvaya Assistant
                  </div>
              ...
              >
                <div className={`max-w-[80%] ${m.sender === "user" ? "order-2" : "order-1"}`}>
                  ...
                  {m.sender === "bot" && m.latency != null && (
                    <div className="font-poppins text-[10px] text-[#9ca3af] mt-1.5 ml-1">
                      {m.latency}ms
                    </div>
                  )}
                </div>
