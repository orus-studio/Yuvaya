...
const Testimonials = () => {
  ...
  return (
    ...
    >
                ...
                >
                  <div className="flex flex-col flex-1 overflow-hidden">
                    ...
                    <div className="shrink-0 mb-2">
                      <p className="font-poppins text-[12.5px] sm:text-[13.5px] line-clamp-3 sm:line-clamp-4 leading-[1.6] text-[#444444]">
                        {t.body}
                      </p>
                    </div>
                  ...
                  <div className="mt-2 pt-2 border-t border-black/5 shrink-0">
                    <p className="font-poppins text-[12px] sm:text-[13px] text-[#555555] mb-0.5">
                      {t.signoff}
                    </p>
              ...
              {testimonials.map((_, i) => (
                <button
                  ...
                  className={`h-2.5 rounded-full transition-all cursor-pointer ${
                    i === index ? "w-7 bg-[#11731b]" : "w-2.5 bg-gray-300 hover:bg-gray-400"
                  }`}
      ...
      <ZigzagSVG
        color="green"
        className="absolute top-[14%] right-[2%] md:right-[5%] lg:right-[15%] z-0 hidden md:block"
        width={85}
        height={50}
