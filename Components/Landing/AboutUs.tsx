...
const AboutUs = () => {
  return (
    ...
    <section
      id="about"
      className="box-border flex rounded-3xl mt-3 min-h-screen w-full flex-col items-center justify-end gap-6 overflow-clip bg-[#26312d] px-4 pt-10 pb-10 sm:gap-8 sm:px-8 md:gap-[30px] md:px-0 md:pt-[40px] md:pb-[60px]"
    >
      {/* About Us heading */}
