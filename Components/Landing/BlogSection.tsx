...
const BlogSection = ({ initialPosts }: BlogSectionProps) => {
  ...
  return (
    <section className="w-full bg-[#fffff7] px-4 sm:px-6 md:px-8 py-12 md:py-20">
      <div
        className="max-w-[1400px] mx-auto bg-[#26312d] rounded-[24px] sm:rounded-[32px] p-8 md:p-12 lg:p-16 flex flex-col lg:flex-row gap-12 lg:gap-16 justify-between items-stretch shadow-xl"
        id="blogs"
      >
        ...
        <div className="w-full lg:w-[35%] flex flex-col justify-between">
          <div className="flex flex-col">
            ...
            <h2 className="font-cormorant font-normal text-[36px] sm:text-[44px] md:text-[52px] leading-[1.15] text-white mb-8 lg:mb-0">
              The Journal <br />
              Skincare,{" "}
              <span className="italic pr-2 bg-gradient-to-r from-[#fffc60] to-[#8cb892] bg-clip-text text-transparent">
                Decoded
              </span>
            </h2>
          </div>
          ...
          {/* Action Button */}
          <Link href={blogUrl} rel="noopener noreferrer" className="mt-8 lg:mt-auto w-fit block">
