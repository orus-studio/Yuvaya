...
const SachetSection = () => {
  ...
  return (
    ...
    >
      ...
      >
        <h2 className="font-switzer whitespace-pre text-center text-[22px] leading-[1.2] tracking-[0em] text-black font-medium  sm:text-[28px] md:text-[36px] lg:text-[50px]">
          <span className="font-switzer font-medium non-italic" style={{ fontStyle: "normal" }}>
            1 Sachet.{" "}
          </span>
          6 powerful Complexes
        </h2>
      </div>
      ...
      >
        {complexes.map((item, index) => {
          ...
          return (
            ...
            >
              {/* ── Dark card container ── */}
              <div className="absolute bottom-0 left-0 box-border flex w-full flex-col flex-nowrap items-center overflow-visible rounded-2xl bg-[#191a1d] sm:rounded-[18px] md:rounded-[20px] lg:rounded-[22px] h-[140px] sm:h-[160px] md:h-[180px] lg:h-[200px] p-2 pb-5 sm:p-2.5 sm:pb-6 md:p-3 md:pb-6 lg:p-3 lg:pb-7 gap-1">
